<x-velzon-layout :title="'Dashboard'" :pageTitle="'Dashboard'">
    <div class="row">
        <div class="col-xl-9">
            <div class="row">
                <div class="col-lg-3">
                        ...
                        <div class="vstack gap-3">
                            ...
                            <div class="d-flex gap-3">
                                ...
                                <div class="flex-shrink-1">
                                    ...
                                    <p class="text-muted mb-0">" Incredibly helpful tips, especially about adding a
                                        call to action. I’ve been missing that step and will implement it in my next
                                        post! "</p>
                                </div>
                            </div>
                            <div class="d-flex gap-3">
                            ...
                            <div class="d-flex gap-3">
                                ...
                                <div class="flex-shrink-1">
                                    ...
                                    <p class="text-muted mb-0">" Loved the section on visual storytelling. It’s true
                                        that images speak louder on social media platforms. More visuals in my next
                                        posts for sure! "</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="table table-hover table-nowrap align-middle mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>20 Sep, 2024</td>
                                    <td><span class="badge bg-success-subtle text-success p-2">MinimalDesign</span>
                                    </td>
                                    <td>23</td>
                                    <td>157</td>
                                    <td>11</td>
                                ...
                                <tr>
                                    ...
                                    <td>09 July, 2024</td>
                                    <td><span class="badge bg-success-subtle text-success p-2">CreativeBlock</span>
                                    </td>
                                    <td>67</td>
                                    <td>1114</td>
                                    <td>1547</td>
