...
await import('./pages/dashboard-blog.init');
...
(function () {
    ...
    function setLanguage(lang) {
        if (document.getElementById("header-lang-img")) {
            if (lang == "en") {
                document.getElementById("header-lang-img").src = new URL('/resources/images/flags/us.svg', import.meta.url).href;
            } else if (lang == "sp") {
                document.getElementById("header-lang-img").src = new URL('/resources/images/flags/spain.svg', import.meta.url).href;
            } else if (lang == "gr") {
                document.getElementById("header-lang-img").src = new URL('/resources/images/flags/germany.svg', import.meta.url).href;
            } else if (lang == "it") {
                document.getElementById("header-lang-img").src = new URL('/resources/images/flags/italy.svg', import.meta.url).href;
            } else if (lang == "ru") {
                document.getElementById("header-lang-img").src = new URL('/resources/images/flags/russia.svg', import.meta.url).href;
            } else if (lang == "ch") {
                document.getElementById("header-lang-img").src = new URL('/resources/images/flags/china.svg', import.meta.url).href;
            } else if (lang == "fr") {
                document.getElementById("header-lang-img").src = new URL('/resources/images/flags/french.svg', import.meta.url).href;
            } else if (lang == "ar") {
                document.getElementById("header-lang-img").src = new URL('/resources/images/flags/ae.svg', import.meta.url).href;
            }
    ...
    function getLanguage() {
        ...
        // request.open("GET", "asset/lang/" + language + ".json");
        request.open("GET", new URL(`/resources/js/lang/${language}.json`, import.meta.url));
                ...
                Array.from(document.querySelectorAll("#notificationItemsTabContent .tab-pane")).forEach(function (elem) {
                    if (elem.querySelectorAll(".notification-item").length > 0) {
                        ...
                        if (!emptyNotificationElem) {
                            var urlbell = new URL('/resources/images/svg/bell.svg', import.meta.url).href;
                            elem.innerHTML += '<div class="empty-notification-elem">\
							<div class="w-25 w-sm-50 pt-3 mx-auto">\
								<img src="' + urlbell + '" class="img-fluid" alt="user-pic">\
							</div>\
